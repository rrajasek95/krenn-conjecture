# The three-invertible incidence survivor fails a factored L0 cut

Research evidence only. Krenn's conjecture remains open,
**SP-CLEAN-BRIDGE** is untouched, and no certified dependency changes.

The exact \(3I+1R+2Z\) packet from
[the linear-incidence survivor](level-two-three-invertible-l0-incidence-survivor.md)
...
in the six unrestricted variables
...
three-invertible incidence locus or prove Krenn's conjecture.

The checker
[verify_level_two_three_invertible_factored_l0_cut_obstruction.py](../computations/verify_level_two_three_invertible_factored_l0_cut_obstruction.py)
