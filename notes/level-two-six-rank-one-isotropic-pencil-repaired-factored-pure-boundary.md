...
certificate does not apply to (M^\dagger), because one of its four core
blocks has changed.  Shared four-slice compatibility on this repaired
packet is a new open question.
