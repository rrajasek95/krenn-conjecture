...
\(\Delta\) of (b_{\rm oth}\) is a unit.  On that open set, (12) is
equivalent to the vanishing of every ((r+1)\times(r+1)) minor obtained by
adjoining one selected column to (b_{\rm oth}\).  This is Cramer's rule
after pivoting on \(\Delta\), so it is a membership criterion, not only a
set-theoretic rank bound.
...
columns.  Condition (15) alone is not sufficient over a nonreduced ring;
the exact condition is the vanishing of (13), or the local augmented-minor
criterion above.
